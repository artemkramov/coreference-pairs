...
from .action import MergeAction, PassAction
...
class State:
    ...
    def move_to_end_state(self, policy: Policy):
        ...
        while next_step_exists:
            ...
            # Make move
            state_new = state_current.move(policy)

            # If it is no more possible tyo move again
            # than stop process
